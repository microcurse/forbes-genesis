...
?>
    ...
    <?php if($custom_footer != 'without'): ?>
		<?php if((is_active_sidebar('footer1') || $fd) && empty($custom_footer)): ?>
			<div class="footer-top footer-top-<?php echo esc_attr($ft); ?>" <?php if($prebg != ''): ?>style="background-color:<?php echo esc_attr($prebg); ?>"<?php endif; ?>>
				<div class="container">
		...
		<?php if((is_active_sidebar('footer2') || $fd) && empty($custom_footer)): ?>
			<footer class="main-footer main-footer-<?php echo esc_attr($ft); ?> text-color-<?php echo esc_attr($fcolor); ?>" <?php if($fbg != ''): ?>style="background-color:<?php echo esc_attr($fbg); ?>"<?php endif; ?>>
				<div class="container">
		...
		<div class="copyright copyright-<?php echo esc_attr($ft); ?> text-color-<?php echo esc_attr($fcolor); ?>" <?php if($copybg != ''): ?>style="background-color:<?php echo esc_attr($copybg); ?>"<?php endif; ?>>
			<div class="container">
