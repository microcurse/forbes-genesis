...
if (($product->get_image() && ( $has_video || $attachment_ids)) || ( $has_video && $attachment_ids)  ) {
	?>
	<div id="product-pager" class="<?php echo esc_attr($carousel_classes); ?>"><?php
        ...
        <script type="text/javascript">
			<?php if ( "horizontal" == $carousel_direction ): ?>
			     jQuery('.product-thumbnails').owlCarousel({
			        items : <?php echo esc_js($carousel_items); ?>,
			...
			<?php elseif( "vertical" == $carousel_direction ): ?>
				<?php $slidesToShow = ( $carousel_items >= $loop+1 ) ? $loop+1 : $carousel_items; ?>
