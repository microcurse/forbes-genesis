...
?>
<div class="row products-loop <?php echo esc_attr($view_class); ?> row-count-<?php echo esc_attr( wc_get_loop_prop( 'columns' ) ); ?> columns-<?php echo esc_attr( wc_get_loop_prop( 'columns' ) ); ?>">
