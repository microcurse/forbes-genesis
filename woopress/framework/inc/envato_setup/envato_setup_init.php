				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => esc_html__( 'Upgrade', 'woopress' ),
							'description' => esc_html__( 'Upgrade Content and Settings', 'woopress' ),
							'pending' => esc_html__( 'Pending.', 'woopress' ),
							'installing' => esc_html__( 'Installing Updates.', 'woopress' ),
							'success' => esc_html__( 'Success.', 'woopress' ),
