        ...
        */
        ...
        public function et_ajax_fonts_remove() {
                ...
                if ( ! isset( $post_data['id'] ) || empty( $post_data['id'] ) ) {
                    $out['messages'][] = esc_html__( 'File ID does not exist', 'woopress' );
                ...
                foreach ( $fonts as $key => $value ) {
                    ...
                    if ( $value['id'] == $post_data['id'] ) {
                        ...
                        if ( etheme_file_exists( $file['url'] ) ) {
                            $out['messages'][] = esc_html__( 'File was\'t deleted', 'woopress' );
                            die();
                        } else {
                            unset( $fonts[$key] );
                        }
                ...
                if ( count( $out['messages'] ) < 1 ){
                    $out['status'] = 'success';
                    $out['messages'][] = esc_html__( 'File was deleted', 'woopress' );
                } 
