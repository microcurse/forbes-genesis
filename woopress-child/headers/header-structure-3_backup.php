<?php
    /**
     * NOTES:
     * This file has been modified to include the search bar in the header inside navbar-right
     * Normal theme options for cart and search type will be disabled with this file
     * 
     */
	$ht = $class = '';
